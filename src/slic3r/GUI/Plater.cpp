    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxSize(42 * wxGetApp().em_unit(), -1)), p(new priv(parent))
{
    ...
    StateColor flush_bd_col(std::pair<wxColour, int>(wxColour(255, 89, 0), StateColor::Pressed),
                            std::pair<wxColour, int>(wxColour(255, 89, 0), StateColor::Hovered),
                ...
                Semver             file_version;
                {
                    ...
                    if (en_3mf_file_type == En3mfType::From_Prusa) {
                        ...
                        if(load_type != LoadType::LoadGeometry)
                            show_info(q, _L("The 3mf is not supported by RackSlicer, load geometry data only."), _L("Load 3mf"));
                    }
                ...
                wxCAPTION | wxCLOSE_BOX)
{
    ...
    m_confirm->SetBorderColor(wxColour(255, 89, 0));
