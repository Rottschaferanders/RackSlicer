    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
    ...
    m_ams_backup_tip->SetForegroundColour(wxColour(0xff5900));
    ...
    m_btn_bg_enable = StateColor(std::pair<wxColour, int>(wxColour(230, 90, 40), StateColor::Pressed), std::pair<wxColour, int>(wxColour(245, 89, 0), StateColor::Hovered),
    ...
    m_statictext_finish->SetForegroundColour(wxColour(255, 89, 0));
    ...
    : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, _L("Modifying the device name"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(230, 90, 40), StateColor::Pressed), std::pair<wxColour, int>(wxColour(255, 89, 0), StateColor::Normal));
    m_button_confirm->SetBackgroundColor(btn_bg_green);
    m_button_confirm->SetBorderColor(wxColour(255, 89, 0));
