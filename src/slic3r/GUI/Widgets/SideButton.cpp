    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(230, 90, 40), StateColor::Pressed);
    border_color.append(wxColour(245, 89, 0), StateColor::Hovered);
    border_color.append(0xff5900, StateColor::Normal);
    ...
    background_color.append(wxColour(230, 90, 40), StateColor::Pressed);
    background_color.append(wxColour(245, 89, 0), StateColor::Hovered);
    background_color.append(0xff5900, StateColor::Normal);
