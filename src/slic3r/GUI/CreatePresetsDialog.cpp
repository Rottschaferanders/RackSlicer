...
#define SELECT_ALL_OPTION_COLOUR wxColour("#ff5900")
...
wxBoxSizer *CreatePrinterPresetDialog::create_hot_bed_stl_item(wxWindow *parent)
{
    ...
    StateColor flush_bd_col(std::pair<wxColour, int>(wxColour(255, 89, 0), StateColor::Pressed), std::pair<wxColour, int>(wxColour(255, 89, 0), StateColor::Hovered),
