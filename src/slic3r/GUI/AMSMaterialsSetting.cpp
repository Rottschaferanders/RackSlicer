...
void AMSMaterialsSetting::create_panel_normal(wxWindow* parent)
{
    ...
    m_readonly_filament->SetBorderColor(StateColor(std::make_pair(0xDBDBDB, (int)StateColor::Focused), std::make_pair(0xff5900, (int)StateColor::Hovered),
    ...
    :PopupWindow(parent, wxBORDER_NONE)
{
    ...
    m_def_colors.push_back(wxColour(0xff5900));
