    ...
    :PopupWindow(parent, wxBORDER_NONE)
{
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(255, 89, 0), StateColor::Pressed), std::pair<wxColour, int>(wxColour(255, 89, 0), StateColor::Normal));
...
void AmsReplaceMaterialDialog::create()
{
    ...
    label_title->SetForegroundColour(0xff5900);
