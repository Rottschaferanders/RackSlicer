...
static const wxColour TEXT_NORMAL_CLR = wxColour(255, 89, 0);
    ...
    :wxPanel(parent, id, pos, size, style)
{
    ...
    StateColor btn_bg(std::pair<wxColour, int>(wxColour(255, 255, 255), StateColor::Disabled), std::pair<wxColour, int>(wxColour(230, 90, 40), StateColor::Pressed),
                      std::pair<wxColour, int>(wxColour(245, 89, 0), StateColor::Hovered), std::pair<wxColour, int>(wxColour(255, 89, 0), StateColor::Enabled),
                      std::pair<wxColour, int>(wxColour(255, 89, 0), StateColor::Normal));
    StateColor btn_bd(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour(255, 89, 0), StateColor::Enabled));
