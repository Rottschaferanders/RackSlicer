...
#define GCODEVIEWER_APP_NAME "RackSlicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "RackSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("RackSlicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
