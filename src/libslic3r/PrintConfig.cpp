...
CLIMiscConfigDef::CLIMiscConfigDef()
{
    ...
    def->tooltip = L("This version of RackSlicer may not understand configurations produced by the newest RackSlicer versions. "
                     "For example, newer RackSlicer may extend the list of supported firmware flavors. One may decide to "
    ...
    def->tooltip = L("If enabled, the command line arguments are sent to an existing instance of GUI RackSlicer, "
                     "or an existing RackSlicer window is activated. "
