...
// When parsing a configuration value, if the old_value is not understood by this RackSlicer version,
// it is being substituted with some default value that this RackSlicer could work with.
