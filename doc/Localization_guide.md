...
1. Get PO-file 'RackSlicer_xx.pot' from corresponding sub-folder here:
https://github.com/softfever/RackSlicer/tree/master/localization/i18n
2. Open this file in PoEdit as "Edit a translation"
3. Apply your corrections to the translation
4. Push changed RackSlicer_xx.po into the original folder
5. copy RackSlicer_xx.mo into resources/i18n/xx and rename it to RackSlicer.mo, then push the changed file.

### Scenario 2. How do I add a new language support
1. Get file RackSlicer.pot here :
https://github.com/softfever/RackSlicer/tree/master/localization/i18n
2. Open it in PoEdit for "Create new translation"
3. Select Translation Language (for example French).
4. As a result you will have fr.po - the file containing translation to French.
Notice. When the translation is complete you need to:
    - Rename the file to RackSlicer_fr.po
    - Click "Save file" button. RackSlicer_fr.mo will be created immediately
    - Bambu_Studio_fr.po needs to be copied into the sub-folder fr of https://github.com/softfever/RackSlicer/tree/master/localization/i18n, and be pushed
	- copy RackSlicer_xx.mo into resources/i18n/xx and rename it to RackSlicer.mo, then push the changed file.
...
https://github.com/softfever/RackSlicer/blob/master/localization/i18n/list.txt.

2.  Create template file(*.POT) with GNUgettext command:
    ```
        xgettext --keyword=L --add-comments=TRN --from-code=UTF-8 --debug -o RackSlicer.pot -f list.txt
    ```
